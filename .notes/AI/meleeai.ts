...
void AIAddDetectionDangerUnits (int player) {
    AIAddDetectionDanger(player, c_GU_Courier);
    AIAddDetectionDanger(player, c_GU_Tesla);
    //AIAddDetectionDanger(player, c_XU_Casnolisk);
...
void AIAddAirDangerUnits (int player) {
    AIAddAirDanger(player, c_GU_Hornet);
    AIAddAirDanger(player, c_GU_Boar);
    AIAddAirDanger(player, c_GU_Jupiter);
    AIAddAirDanger(player, c_GU_Badger);
    AIAddAirDanger(player, c_GB_AssemblyArray);
...
void KeironBasicDefenseStock (int player) {
    ...
    AIAddEmergencyDefenseStock(player, 4, c_KU_Subjecter, true);
